...
public class RadioTest {
    ...
    @Test
    public void shouldSetNextWaveInTheBorderOfTheBeginning() {
        Radio radio = new Radio();
        radio.setCurrentWave(1);
    ...
    @Test
    public void shouldSetNextWaveInTheBorderOfTheEnd() {
        Radio radio = new Radio();
        radio.setCurrentWave(8);
    ...
    @Test
    public void shouldSetPrevWaveInTheBorderOfTheBeginning() {
        Radio radio = new Radio();
        radio.setCurrentWave(1);
    ...
    @Test
    public void shouldSetPrevWaveBorderOfTheInTheEnd() {
        Radio radio = new Radio();
        radio.setCurrentWave(8);
